...
const events_gym_2 = [
  { title: 'Mini: Watkins Memorial Team3 vs Heath Team2', start: new Date(2024, 8, 1, 16, 0), end: new Date(2024, 8, 1, 18, 0) },
  { title: 'Mini: Lakewood Team1 vs Johnstown Team4', start: new Date(2024, 8, 2, 16, 0), end: new Date(2024, 8, 2, 18, 0) },
  ...
  { title: 'Mini: Watkins Memorial Team1 vs Heath Team2', start: new Date(2024, 8, 8, 16, 0), end: new Date(2024, 8, 8, 18, 0) },
  { title: 'Mini: Utica Team2 vs Heath Team1', start: new Date(2024, 8, 9, 16, 0), end: new Date(2024, 8, 9, 18, 0) },
  ...
  { title: 'Mini: Watkins Memorial Team1 vs Licking Heights Team1', start: new Date(2024, 8, 15, 16, 0), end: new Date(2024, 8, 15, 18, 0) },
  { title: 'Mini: Licking Heights Team2 vs Utica Team1', start: new Date(2024, 8, 16, 16, 0), end: new Date(2024, 8, 16, 18, 0) },
  ...
  { title: 'Mini: Watkins Memorial Team3 vs Licking Heights Team1', start: new Date(2024, 8, 22, 16, 0), end: new Date(2024, 8, 22, 18, 0) },
  { title: 'Mini: Watkins Memorial Team4 vs Licking Heights Team2', start: new Date(2024, 8, 23, 16, 0), end: new Date(2024, 8, 23, 18, 0) },
  ...
  { title: 'Mini: Lakewood Team4 vs Johnstown Team1', start: new Date(2024, 8, 29, 16, 0), end: new Date(2024, 8, 29, 18, 0) },
  { title: 'Mini: Watkins Memorial Team4 vs Heath Team1', start: new Date(2024, 8, 30, 16, 0), end: new Date(2024, 8, 30, 18, 0) },
  ...
  { title: 'Mini: Licking Heights Team4 vs Utica Team2', start: new Date(2024, 9, 6, 16, 0), end: new Date(2024, 9, 6, 18, 0) },
  { title: 'Mini: Heath Team4 vs Johnstown Team2', start: new Date(2024, 9, 7, 16, 0), end: new Date(2024, 9, 7, 18, 0) },
  ...
  { title: 'Mini: Licking Heights Team3 vs Utica Team2', start: new Date(2024, 9, 13, 16, 0), end: new Date(2024, 9, 13, 18, 0) },
  { title: 'Mini: Watkins Memorial Team1 vs Heath Team3', start: new Date(2024, 9, 14, 16, 0), end: new Date(2024, 9, 14, 18, 0) },
  ...
  { title: 'Mini: Utica Team2 vs Johnstown Team4', start: new Date(2024, 9, 20, 16, 0), end: new Date(2024, 9, 20, 18, 0) },
  { title: 'Mini: Licking Heights Team4 vs Lakewood Team3', start: new Date(2024, 9, 21, 16, 0), end: new Date(2024, 9, 21, 18, 0) },
